    ...
    def get_no_color_program(self):
        ...
        for (line_num, line) in enumerate(self.listOfLines):
            if 'color([' not in line:
                self.nocolorprogram.append(line)
        return self.nocolorprogram

...
import json
#TBD: use config
config_path = "/home/cli7/yhc_Workspace/SPA/real_exp/config_llama2.json"
...
data_path = os.path.join(config_data["world_info"]["depth_folder_base_path"],config_data[instance_name]["cube_name"] )
res_dir = config_data['world_info']['res_dir']
# res_dir = "/home/cli7/yhc_Workspace/SPA/real_exp/prediction"
# get_seg(SOURCE_IMAGE_PATH, '/root/autodl-tmp/0712/rz=0/gen1_detect.png')
# cubeid = os.path.basename(data_path).split('.')[0]
cubeid = config_data[instance_name]["cube_name"].split('.')[0]

CLASSES_to_label = config_data[instance_name]["CLASSES_to_label_llama2"]
typediscribe = config_data[instance_name]["type"]
